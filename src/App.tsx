...
class App extends React.Component {
  ...
  createPaymentTxMoon = async (): Promise<void> => {
    try {
      const { torus } = web3Obj;
      const res = await torus.initiateTopup('moonpay', {
        selectedCurrency: 'USD',
      });
      console.log(res);
    } catch (error) {
        ...
        <div>
          ...
          >
            ...
            <section style={{ marginTop: '20px' }}>
              ...
              <button onClick={this.createPaymentTx}>Create Payment mercuryo</button>
              <button onClick={this.createPaymentTxMoon}>Create Payment moonpay</button>
